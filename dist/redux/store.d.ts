...
export declare const useChonkyStore: (chonkyInstanceId: string) => import("@reduxjs/toolkit/dist/configureStore").ToolkitStore<RootState, import("redux").AnyAction, import("@reduxjs/toolkit").MiddlewareArray<any>>;
/**
